...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'ljtrtool.twig.extension.todo' => 'getLjtrtool_Twig_Extension_TodoService',
            'locale_listener' => 'getLocaleListenerService',
            'logger' => 'getLoggerService',
            'matm.dataset_maker' => 'getMatm_DatasetMakerService',
            'matm.typeahead_transformer' => 'getMatm_TypeaheadTransformerService',
            'matm.typeahead_type' => 'getMatm_TypeaheadTypeService',
            ...
            'security.user.provider.concrete.userlogin' => 'getSecurity_User_Provider_Concrete_UserloginService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\ConfigurationResource(array('bootstrap_css' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/less/bootstrap.less'), 1 => ($this->targetDirs[3].'/vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/DependencyInjection/../Resources/less/form.less')), 1 => array(0 => 'less'), 2 => array('output' => 'bundles/bootstrap/css/bootstrap.css')), 'bootstrap_js' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/transition.js'), 1 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/alert.js'), 2 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/button.js'), 3 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/carousel.js'), 4 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/collapse.js'), 5 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/dropdown.js'), 6 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/modal.js'), 7 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/tooltip.js'), 8 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/popover.js'), 9 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/scrollspy.js'), 10 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/tab.js'), 11 => ($this->targetDirs[2].'/../vendor/twbs/bootstrap/js/affix.js'), 12 => ($this->targetDirs[3].'/vendor/braincrafted/bootstrap-bundle/Braincrafted/Bundle/BootstrapBundle/DependencyInjection/../Resources/js/bc-bootstrap-collection.js')), 1 => array(), 2 => array('output' => 'bundles/bootstrap/js/bootstrap.js')), 'jquery' => array(0 => array(0 => ($this->targetDirs[2].'/../vendor/jquery/jquery/jquery-*.js')), 1 => array(), 2 => array('output' => 'bundles/bootstrap/js/jquery.js')))), 'config');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LJTrToolRegistrationBundle', ($this->targetDirs[2].'/Resources/LJTrToolRegistrationBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'LJTrToolRegistrationBundle', ($this->targetDirs[3].'/src/LJTrTool/RegistrationBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        $this->services['assetic.filter.less'] = $instance = new \Assetic\Filter\LessFilter('C:/Program Files (x86)/nodejs/node.exe', array(0 => 'C:/Users/Tim/AppData/Roaming/npm/node_modules'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'dbname' => 'symfony', 'user' => 'symfony', 'password' => 'symfony', 'port' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/LJTrTool/RegistrationBundle/Entity'))), 'LJTrTool\\RegistrationBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('LJTrToolRegistrationBundle' => 'LJTrTool\\RegistrationBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_6affb4e9918ea1b24c516378c8455c67c8f8fc1e8de72a601df40990f94d08d3');
    ...
    /**
     * Gets the 'ljtrtool.twig.extension.todo' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \LJTrTool\RegistrationBundle\Twig\Extension\TodoExtension A LJTrTool\RegistrationBundle\Twig\Extension\TodoExtension instance.
     */
    protected function getLjtrtool_Twig_Extension_TodoService()
    {
        return $this->services['ljtrtool.twig.extension.todo'] = new \LJTrTool\RegistrationBundle\Twig\Extension\TodoExtension($this->get('doctrine'));
    }
    ...
    /**
     * Gets the 'matm.dataset_maker' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MatM\Bundle\TypeAheadBundle\Services\TypeAheadDataBuilder A MatM\Bundle\TypeAheadBundle\Services\TypeAheadDataBuilder instance.
     */
    protected function getMatm_DatasetMakerService()
    {
        return $this->services['matm.dataset_maker'] = new \MatM\Bundle\TypeAheadBundle\Services\TypeAheadDataBuilder();
    }

    /**
     * Gets the 'matm.typeahead_transformer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MatM\Bundle\TypeAheadBundle\Form\DataTransformer\TypeAheadTransformer A MatM\Bundle\TypeAheadBundle\Form\DataTransformer\TypeAheadTransformer instance.
     */
    protected function getMatm_TypeaheadTransformerService()
    {
        return $this->services['matm.typeahead_transformer'] = new \MatM\Bundle\TypeAheadBundle\Form\DataTransformer\TypeAheadTransformer($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'matm.typeahead_type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MatM\Bundle\TypeAheadBundle\Form\Type\TypeAheadType A MatM\Bundle\TypeAheadBundle\Form\Type\TypeAheadType instance.
     */
    protected function getMatm_TypeaheadTypeService()
    {
        return $this->services['matm.typeahead_type'] = new \MatM\Bundle\TypeAheadBundle\Form\Type\TypeAheadType($this->get('matm.typeahead_transformer'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DefaultService()
    {
        ...
        $b = $this->get('security.user.provider.concrete.userlogin');
        ...
        $h = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $b), 'RW5MGwq5ppEKYe5zEDFhXnpxS', 'default', array('lifetime' => 300, 'path' => '/', 'secure' => true, 'name' => 'REMEMBERME', 'domain' => NULL, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $c);

        $i = new \Symfony\Component\Security\Http\Firewall\LogoutListener($a, $e, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($e, '/events'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        $l = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $g, $this->get('security.authentication.session_strategy'), $e, 'default', $j, $k, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $c, $d, $this->get('security.csrf.token_manager'));
        $l->setRememberMeServices($h);

        $m = new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, '/login', false);

        return $this->services['security.firewall.map.context.default'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'default', $c, $d), 2 => $i, 3 => $l, 4 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($a, $g, 'default', $m, $c), 5 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $h, $g, $c, $d, true), 6 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '55c76766ead7d7.70994817', $c, $g), 7 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'default', $m, NULL, NULL, $c));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_DemoSecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.demo_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.userlogin')), 'demo_secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), $this->get('security.authentication.session_strategy'), $d, 'demo_secured_area', $g, $h, array('check_path' => '_demo_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'demo_secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, '_demo_login', false), NULL, NULL, $b));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('tim.sochart@gmail.com');
        $a->setPassword('DWbPNHA1gdKnO3ORs5Dxw7iFw');
        $a->setAuthMode('login');
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig', 2 => 'MatMTypeAheadBundle:Form:typeahead-form-theme.html.twig'), 'autoescape' => array(0 => 'Symfony\\Bundle\\TwigBundle\\TwigDefaultEscapingStrategy', 1 => 'guess'), 'charset' => 'UTF-8', 'paths' => array()));

        $instance->addExtension($this->get('ljtrtool.twig.extension.todo'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'BraincraftedBootstrapBundle:Form:bootstrap.html.twig', 2 => 'MatMTypeAheadBundle:Form:typeahead-form-theme.html.twig')), $this->get('form.csrf_provider', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
        $instance->addExtension(new \Twig_Extension_Debug());
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'LJTrToolRegistrationBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/LJTrTool/RegistrationBundle/Resources/views'), 'LJTrToolRegistration');
        ...
        $instance->addPath(($this->targetDirs[3].'/vendor/matm/typeaheadbundle/MatM/Bundle/TypeAheadBundle/Resources/views'), 'MatMTypeAhead');
    ...
    /**
     * Gets the 'security.user.provider.concrete.userlogin' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getSecurity_User_Provider_Concrete_UserloginService()
    {
        return $this->services['security.user.provider.concrete.userlogin'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'LJTrToolRegistrationBundle:Account', NULL, NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'LJTrToolRegistrationBundle' => 'LJTrTool\\RegistrationBundle\\LJTrToolRegistrationBundle',
                'BraincraftedBootstrapBundle' => 'Braincrafted\\Bundle\\BootstrapBundle\\BraincraftedBootstrapBundle',
                'MatMTypeAheadBundle' => 'MatM\\Bundle\\TypeAheadBundle\\MatMTypeAheadBundle',
            ...
            'twig.form.resources' => array(
                ...
                2 => 'MatMTypeAheadBundle:Form:typeahead-form-theme.html.twig',
            ),
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'tim.sochart@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'DWbPNHA1gdKnO3ORs5Dxw7iFw',
            ...
            'assetic.filter.less.node' => 'C:/Program Files (x86)/nodejs/node.exe',
            'assetic.filter.less.node_paths' => array(
                0 => 'C:/Users/Tim/AppData/Roaming/npm/node_modules',
            ),
            ...
            'braincrafted_bootstrap.output_dir' => 'bundles/bootstrap',
